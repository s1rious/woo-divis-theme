...
<form class="woocommerce-cart-form row" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
    <div class="col-lg-8 cart-table">
                    ...
                    foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
                        ...
                        if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
                            ...
                            <tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
                                ...
                                <td class="product-name product-col">
                                    <?php
        ...
        <div class="total-cost">
            <h6>Subtotal <span><?php echo $woocommerce->cart->get_cart_subtotal()?></span></h6>
            <h6>Total <span><?php echo $woocommerce->cart->get_cart_total()?></span></h6>
        </div>
    ...
    <div class="col-lg-4 cart-collaterals">
        ...
        <?php if ( wc_coupons_enabled() ) { ?>
            <div class="coupon promo-code-form">
        ...
        <a href="<?php echo esc_url(get_home_url() . '/checkout'); ?>" class="site-btn mb-3 mt-3"><?php esc_html_e( 'Proceed to checkout', 'woocommerce' ); ?></a>
